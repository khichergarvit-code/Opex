...
const MATRIX: Row[] = [
  ...
  { role: 'workspace_admin', action: 'admin:models:manage', expected: false },
  { role: 'employee', action: 'admin:models:manage', expected: false },
  { role: 'workspace_admin', action: 'admin:agents:manage', expected: false },
  ...
  { role: 'workspace_admin', action: 'admin:system:read', expected: false },
